...
let favBreakfast = 'waffles'
let favLunch = 'mealprep'
let favDinner = 'steak and broccoli'
...
function teachPerson(myPerson: Person, type: Skill []): void {
...
function getRandomSkill(myPerson): void {
  return 
}
